...
export default function Navbar() {
  return (
    <div className="mx-2 pt-2">
      <nav className="text-white flex items-center justify-between rounded-[35px] p-2 px-3 pr-4 max-w-7xl mx-auto">
        <button className="hidden sm:flex ml-2">
          {/* maybe add glow hover to this buttton - shadow is in globals.css*/}
          <Link href="/" className="flex items-center">
            <img src="\cartoonpfp.png" className="w-12 h-12 outline-img"></img>
            <p className="ml-3 text-2xl font-bold">Ellie</p>
          </Link>
        </button>
        ...
        <div className="navbar-center hidden sm:flex">
          <ul className="menu menu-horizontal font-semibold text-xl">
            ...
            <li>
              <Link href="/design">Projects</Link>
            </li>
          </ul>
        </div>
