export default function Home() {
  return (
    <div className="min-h-screen">
      <main className="flex p-4 max-w-6xl mx-auto justify-center sm:flex-nowrap flex-wrap mt-6 sm:mt-24">
        <div className="max-w-lg mr-0 sm:mr-6">
          ...
          <p className="mb-2">
            ...
            my blogs that are on other sites, & some of my design related stuff!
          </p>
          <p>See ya!</p>

          <div className="social-icons flex mt-6 items-center">
            ...
            <a
              href="https://github.com/elliezub"
              target="_blank"
            ...
            <a
              href="https://www.twitch.tv/elliezub"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
              ...
              >
                ...
                >
                  <g transform="scale(5.33333,5.33333)">
                    <path
                      d="M41.754,27.958l-8.455,9.699c-0.19,0.218 -0.465,0.343 -0.754,0.343h-6.175c-0.239,0 -0.47,0.085 -0.651,0.241l-6.438,5.519c-0.181,0.155 -0.412,0.24 -0.651,0.24h-1.63c-0.552,0 -1,-0.448 -1,-1v-4c0,-0.552 -0.448,-1 -1,-1h-8c-0.552,0 -1,-0.448 -1,-1v-21.057c0,-0.156 0.036,-0.309 0.106,-0.448l3.981,-7.943c0.17,-0.338 0.516,-0.552 0.894,-0.552h30.019c0.552,0 1,0.448 1,1v19.301c0,0.242 -0.087,0.475 -0.246,0.657z"
                      fill="#8343c8"
                    ></path>
                    <path
                      d="M39,26.369c-1.667,1.877 -3.333,3.754 -5,5.631c-2.333,0 -4.667,0 -7,0c-2.333,2 -4.667,4 -7,6c0,-2 0,-4 0,-6c-2.667,-0.008 -5.333,-0.016 -8,-0.024c0,-7.326 0,-14.651 0,-21.976c9,0 18,0 27,0c0,5.456 0,10.912 0,16.369z"
                      fill="#fafafa"
                    ></path>
                    <rect
                      x="21"
